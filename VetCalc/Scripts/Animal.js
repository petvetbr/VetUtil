...
var Animal = (function () {
    ...
    Animal.prototype.calcVitals = function () {
        switch(this.species) {
            case ("canina"):
 {
            ...
            default:
 {
    ...
    Animal.prototype.setDehidrationPercent = function (perc) {
        this.dehidrationPercent = ko.observable(perc);
        this.calcRepoVolume();
    };
    Animal.prototype.calcDehitration = function () {
        this.calcRepoVolume();
    };
    Animal.prototype.calcRepoVolume = function () {
    ...
    Animal.prototype.GetCanineVitals = function () {
        if(this.weightKg() > 0) {
    ...
    Animal.prototype.GetFelineVitals = function () {
        if(this.weightKg() > 0) {
    ...
    Animal.prototype.GetEquineVitals = function () {
        if(this.weightKg() > 0) {
    ...
    Animal.prototype.GetBovineVitals = function () {
        if(this.weightKg() > 0) {
    ...
    Animal.prototype.GetSheepVitals = function () {
    ...
    Animal.prototype.GetGoatVitals = function () {
        this.minweight = ko.observable(1);
    ...
    Animal.prototype.GetSwineVitals = function () {
        this.minweight = ko.observable(1);
